...
from utils.rate_limited_embeding import RateLimitedEmbeddings
...
class DataIngestion:
    ...
    def store_in_vector_db(self, documents: List[Document]):
        ...
        base_embeddings = self.model_loader.load_embeddings()
        print("Storing documents in AstraDB vector store...")
        vstore = AstraDBVectorStore(
            embedding=RateLimitedEmbeddings(base_embeddings, delay=1.1),
